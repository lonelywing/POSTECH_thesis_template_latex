...
% comment out committee and approval details and import scanned signature pages here
% \approval{advisor-approval-filename.pdf}{committee-approval-filename.pdf}
...
\begin{document}
    ...
    % the university requires a blank page separating abstract and contents, but it's acceptable to include a dedication on the separating page
    \dedication{}
...
\bibliographystyle{unsrturl-inline}
\bibliography{mybib}
